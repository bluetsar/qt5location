...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QGeoRoutingManagerEngineNokia_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 84, 11)
    ...
    "QGeoRouteReply::Error\0error\0errorString\0"
};
...
const QMetaObject QGeoRoutingManagerEngineNokia::staticMetaObject = {
    { &QGeoRoutingManagerEngine::staticMetaObject, qt_meta_stringdata_QGeoRoutingManagerEngineNokia.data,
      qt_meta_data_QGeoRoutingManagerEngineNokia,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGeoRoutingManagerEngineNokia.stringdata))
        return static_cast<void*>(const_cast< QGeoRoutingManagerEngineNokia*>(this));
