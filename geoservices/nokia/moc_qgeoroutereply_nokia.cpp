...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QGeoRouteReplyNokia_t, stringdata) + ofs \
...
const QMetaObject QGeoRouteReplyNokia::staticMetaObject = {
    { &QGeoRouteReply::staticMetaObject, qt_meta_stringdata_QGeoRouteReplyNokia.data,
      qt_meta_data_QGeoRouteReplyNokia,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGeoRouteReplyNokia.stringdata))
        return static_cast<void*>(const_cast< QGeoRouteReplyNokia*>(this));
