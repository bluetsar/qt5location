...
#else
        QPointer<QLandmarkIdFetchRequest> ireq(req); //Take this in case the first emit delete us
#endif
...
#else
        QPointer<QLandmarkFetchRequest> ireq(req); //Take this incase the first emit deletes us.
#endif
...
#else
        QPointer<QLandmarkFetchByIdRequest> ireq(req); //Take this in case the first emit delete us
#endif
