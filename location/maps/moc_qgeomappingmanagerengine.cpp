/****************************************************************************
** Meta object code from reading C++ file 'qgeomappingmanagerengine.h'
**
...
#error "The header file 'qgeomappingmanagerengine.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QGeoMappingManagerEngine_t, stringdata) + ofs \
...
const QMetaObject QGeoMappingManagerEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGeoMappingManagerEngine.data,
      qt_meta_data_QGeoMappingManagerEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGeoMappingManagerEngine.stringdata))
        return static_cast<void*>(const_cast< QGeoMappingManagerEngine*>(this));
