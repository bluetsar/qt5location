/****************************************************************************
** Meta object code from reading C++ file 'qgeotiledmapreply.h'
**
...
#include "tiled/qgeotiledmapreply.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'qgeotiledmapreply.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QGeoTiledMapReply_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 59, 11)
    ...
    "QGeoTiledMapReply\0finished\0\0error\0"
    "QGeoTiledMapReply::Error\0errorString\0"
};
...
void QGeoTiledMapReply::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->error((*reinterpret_cast< QGeoTiledMapReply::Error(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->error((*reinterpret_cast< QGeoTiledMapReply::Error(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QGeoTiledMapReply::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (QGeoTiledMapReply::*_t)(QGeoTiledMapReply::Error , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QGeoTiledMapReply::error)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QGeoTiledMapReply::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGeoTiledMapReply.data,
      qt_meta_data_QGeoTiledMapReply,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGeoTiledMapReply.stringdata))
        return static_cast<void*>(const_cast< QGeoTiledMapReply*>(this));
